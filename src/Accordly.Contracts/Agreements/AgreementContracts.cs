...
/// <summary>Request to partially update an agreement.</summary>
public sealed record UpdateAgreementRequest(string? Title, DateTimeOffset? ExpiresAt, string? Status);
